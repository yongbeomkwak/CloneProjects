...
extension UIView {
    ...
    func setHorizon(constant : CGFloat) {
        self.translatesAutoresizingMaskIntoConstraints = false
        guard let view = self.superview else { return }
        self.setAnchor(leading:view.leadingAnchor,
                       paddingLeading: constant,
                       trailing: view.trailingAnchor,
                       paddingTrailing: constant)
        
    }
    
    func setVertical(constant : CGFloat) {
        self.translatesAutoresizingMaskIntoConstraints = false
        guard let view = self.superview else { return }
        self.setAnchor(top:view.topAnchor, 
                       paddingTop: constant,
                       bottom: view.bottomAnchor,
                       paddingBottom: constant)
